              ...
              <div class="container position-relative z-index-2 space-2-top space-3-bottom space-5--md">
                <div class="w-50 w-md-40">
                  <div class="mb-5">
                    ...
                    <p class="lead">Categorize expenses and plan each week of the month.</p>
                    <p></p>
                  </div>
                </div>
                <div class="w-50">
...
<form:form modelAttribute="expenseIncome" action="addExpenseIncome" class="w3-container w3-card-4" method="post">
      ...
      <h2>Enter an Expense or Income:</h2>
      ...
      <table>
      			<tr>
					...
					<th> <div class=" h2Button specialTD "  >
					    ...
					    <input type="radio" name="ExpenseOrIncomeOption" value="2">  Expense
				  	</div> </th>
				</tr>
      			<tr>
				...
				<tr>
					<td>Due Date</td>
					<td><input type="text"   class="form-control"   placeholder="Due Date" name="dateDue" required /></td>
				</tr>	
				
								
				<tr>
					<td>Expense or Income Name</td>
					<td><input type="text"   class="form-control"   placeholder="Expense or Income Name" name="eiName" required /></td>
				</tr>			
				<tr>
					<td>Expense or Income Amount</td>
					<td><input type="text"   class="form-control"   placeholder="Expense or Income Amount" name="eiAmount" required /></td>
				</tr>

				<tr>
					<td>Expense or Income Debt</td>
					<td><input type="text"   class="form-control"   placeholder="Expense or Income Debt Total" name="eiDebtTotal" required /></td>
				</tr>
